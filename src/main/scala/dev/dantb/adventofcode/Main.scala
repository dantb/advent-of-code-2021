...
@main def Main(args: String*): Unit =
  ...
  println(s"Day 9, part 1 sample: ${Day9.solveSample}")
  println(s"Day 9, part 1: ${Day9.solvePart1}")
  println(s"Day 9, part 2 sample: ${Day9.solveSamplePart2}")
  println(s"Day 9, part 2: ${Day9.solvePart2}")

  println(s"Day 10, part 1 sample: ${Day10.solveSample}")
  println(s"Day 10, part 1: ${Day10.solvePart1}")
  println(s"Day 10, part 2 sample: ${Day10.solvePart2Sample}")
  println(s"Day 10, part 2: ${Day10.solvePart2}")

  println(s"Day 11, part 1 sample: ${Day11.solveSample}")
  println(s"Day 11, part 1: ${Day11.solvePart1}")
  println(s"Day 11, part 2: ${Day11.solvePart2}")

  println(s"Day 14, part 1 sample: ${Day14.solveSample}")
  println(s"Day 14, part 1: ${Day14.solvePart1}")
  println(s"Day 14, part 2 sample: ${Day14.solvePart2Sample}")
  println(s"Day 14, part 2: ${Day14.solvePart2}")
